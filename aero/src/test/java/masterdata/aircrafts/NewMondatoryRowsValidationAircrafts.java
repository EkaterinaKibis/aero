...
public class NewMondatoryRowsValidationAircrafts {
    WebDriver driver;

    HashMap<String, String> propertiesMap;
    Random random = new Random();
    private static final Logger LOGGER = LogManager.getLogger(NewMondatoryRowsValidationAircrafts.class.getName());
