...
/**
 * 004 Проверка заполнения  полей (всплывание ошибок) при создании новой записи в окне Movements Append
 */

public class NewFieldsValidationMovements {
    WebDriver driver;
