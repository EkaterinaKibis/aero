...
public class NewSeasonCreate {
    ...
    public void initTest() throws IOException {
        InputStream in = DataStartBiggerThenDataFinishInEdit.NewRecordCreationValid.class.getClassLoader().getResourceAsStream("seasonTest.properties");
    ...
    public void newRecordCreation() throws InterruptedException {
        ...
        assertThat(text.getText().contains(iataElement.getText()), is(true));
    ...
    public void newRecordCloseWithoutsaving() throws InterruptedException {
        ...
        assertThat(text.getText().contains(iataElement.getText()), is(false));

        String query = "Select * from master_data.masterdata.movements where iata = '" + iataElement.getText() + "'";
