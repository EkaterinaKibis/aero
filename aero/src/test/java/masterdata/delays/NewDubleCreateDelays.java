...
public class NewDubleCreateDelays {
    WebDriver driver;
    ...
    public void newDubleCreating() throws InterruptedException {
        ...
        assertThat(pageText.contains("GFFS"), is(true));
    ...
    public void  dubleCreateNewDuble() throws InterruptedException {
        ...
        assertThat(pageText.contains("GFFS"), is(true));
        assertThat(pageText.contains("GSgS"), is(true));
    ...
    public void  dubleCreateDubleButton() throws InterruptedException {
        ...
        assertThat(pageText.contains(iataElement.getText()), is(true));
